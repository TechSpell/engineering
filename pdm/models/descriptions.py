...
#     def on_change_stddesc(self, cr, uid, std_description=False, context=None):
        ...
        if self.std_description:
            objDescription=self.env['plm.description']
            thisObject=objDescription.browse(self.std_description.id)
            if thisObject.description:
                self.description=thisObject.description
                if thisObject.umc1:
                    self.std_umc1=thisObject.umc1
                if thisObject.umc2:
                    self.std_umc2=thisObject.umc2
                if thisObject.umc3:
                    self.std_umc3=thisObject.umc3
                if thisObject.unitab:
                    self.description=self.description+" "+thisObject.unitab
  
#     @api.onchange('std_value1, std_value2, std_value3')
#     def on_change_stdvalue(self):
# 
#         std_description=self.std_description
#         std_umc1=self.std_umc1
#         std_value1=self.std_value1
#         std_umc2=self.std_umc2
#         std_value2=self.std_value2
#         std_umc3=self.std_umc3
...
#             thisObject=thisDescription.browse(self.std_description)
#             if thisObject.description:
...
#                 self.description=description
    ...
    ##  External callable
    @api.model
    def GetComposedDesc(self, request=[False,False,False,False,False,False,False]):
