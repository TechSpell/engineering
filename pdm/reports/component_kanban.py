...
class ComponentDashboard(models.Model):
    ...
    def open_action(self):
        ...
        return self.common_open(_('New Component'), 'product.product', 'form', 'form', self.ids[0], self.pool.context)

    @api.multi
    def create_component(self):
        print 'New Component'
        return self.common_open(_('New Component'), 'product.product', 'form', 'form', False, self.pool.context)
    ...
    def open_normal_bom(self):
        ...
        return self.common_open(_('Related Boms'), 'mrp.bom', 'tree,form', 'form', boms.ids, self.pool.context, domain)
    ...
    def open_related_docs_action(self):
        ...
        return self.common_open(_('Related Documents'), 'plm.document', 'tree,form', 'form', docs.ids, self.pool.context, domain)
    ...
    def create_normal_bom(self):
        print 'Open Normal Boms'
        context = self.pool.context.copy()
